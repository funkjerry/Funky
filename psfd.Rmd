  ...
  title=
    "主樣本的工作、經濟滿意度分數",
      x="主樣本出生年度",y="平均分數",
        caption="(1分最低，4分最高)")+
        theme_light()+
    annotate("text",x = 1:5, y=3.10,size=3.5, label=c("3492","3143","5091","8402","1419"),colour="#00BFC4",fontface="bold")+
annotate("text",x = 1:5, y=3.03,size=3.5, label=c("956","1707","1094","2914","1582"),colour="#F8766D",fontface="bold")+
annotate("text",x=0.45,y=3.06,size=3.5,label="n",fontface="bold")+
ylim(2.53,3.15)->graph$work
###d12
d12 %>%
  ggplot(aes(x=scale, y=point, group=category, color=category))+
  geom_line(linetype="solid", size=1)+
  ...
  title=
    "主樣本的家庭、婚姻(同居)滿意度分數",
      x="主樣本出生年度",y="平均分數",
        caption="(1分最低，4分最高)")+
    annotate("text",x = 1:5, y=3.43,size=3.5, label=c("365","536","418","954","570"),colour="#00BFC4",fontface="bold")+
annotate("text",x = 1:5, y=3.38,size=3.5, label=c("4978","9699","5831","9501","1584"),colour="#F8766D",fontface="bold")+
annotate("text",x=0.45,y=3.41,size=3.5,label="n",fontface="bold")+
ylim(3,3.45)->graph$family
