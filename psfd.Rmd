...
d3 %>%
  ...
  labs(
    ...
    x="主樣本出生年度(1到5波次)",y="平均分數",
    caption = "(1分最低，7分最高)")+
annotate("text",x = 1:5, y=5.17,size=4, label=c("4981","9714","5834","9504","3554"),colour="#F8766D",fontface="bold")+
annotate("text",x = 1:5, y=5.13,size=4, label=c("4980","9718","5835","9504","3558"),colour="#00BFC4",fontface="bold")+
annotate("text",x=0.6,y=5.15,size=5,label="N",fontface="bold")+mytheme+ylim(4.65,NA)->graph$happylife
###d6 
d6 %>%
  ggplot(aes(x=scale, y=point, group=category, color=category))+
  geom_line(linetype="solid", size=1,alpha=0.4)+
  ...
  labs(
    title="主樣本和其伴侶的自評健康分數",x="主樣本出生年度(1到5波次)",y="平均分數",caption = "(1分最低，5分最高)")+
    annotate("text",x = 1:5, y=4.15,size=4, label=c("5977","11683","6983","11687","3559"),colour="#F8766D",fontface="bold")+
annotate("text",x = 1:5, y=4.05,size=4, label=c("4871","8745","5136","5439","1147"),colour="#00BFC4",fontface="bold")+
  annotate("text",x=0.5,y=4.1,size=5,label="N",fontface="bold")+
  mytheme+ylim(3.08,NA)->graph$health
###d11
d11 %>%
  ggplot(aes(x=scale, y=point, group=category, color=category))+
  geom_line(linetype="solid", size=1,alpha=0.4)+
  ...
  title=
    "主樣本的工作、經濟滿意度分數",
      x="主樣本出生年度",y="平均分數",
        caption="(1分最低，4分最高)")+
        theme_light()+
    annotate("text",x = 1:5, y=3.10,size=4, label=c("3492","3143","5091","8402","1419"),colour="#00BFC4",fontface="bold")+
annotate("text",x = 1:5, y=3.03,size=4, label=c("956","1707","1094","2914","1582"),colour="#F8766D",fontface="bold")+
annotate("text",x=0.5,y=3.065,size=5,label="N",fontface="bold")+
  mytheme+ylim(2.51,NA)->graph$work
###d12
d12 %>%
  ggplot(aes(x=scale, y=point, group=category, color=category))+
  geom_line(linetype="solid", size=1,alpha=0.4)+
  ...
  title=
    "主樣本的家庭、婚姻(同居)滿意度分數",
      x="主樣本出生年度",y="平均分數",
        caption="(1分最低，4分最高)")+
    annotate("text",x = 1:5, y=3.43,size=4, label=c("365","536","418","954","570"),colour="#00BFC4",fontface="bold")+
annotate("text",x = 1:5, y=3.38,size=4, label=c("4978","9699","5831","9501","1584"),colour="#F8766D",fontface="bold")+
annotate("text",x=0.5,y=3.41,size=5,label="N",fontface="bold")+
  mytheme+ylim(3,NA)->graph$family
