...
happy %>%
  ...
  geom_point(size=3,alpha=0.8)+
    ...
    labs(title="主樣本的生活過得快樂嗎",
      x="調查年度",y="平均分數",caption="(1分最低，7分最高)")+mytheme->graph2$happyp
ggplotly(
...
life %>%
  ...
  geom_point(size=3,alpha=0.8)+
    ...
    labs(title="主樣本的生活過得好不好",
      x="調查年度",y="平均分數",caption="(1分最低，7分最高)")+mytheme->graph2$lifep
ggplotly(
...
health %>%
  ...
  geom_point(size=3,alpha=0.8)+
    ...
    labs(title="主樣本的自評健康狀態",
      x="調查年度",y="平均分數",caption="(1分最低，5分最高)")+mytheme->graph2$healthp
ggplotly(
...
Shealth %>%
  ...
  geom_point(size=3,alpha=0.8)+
    ...
    labs(title="主樣本伴侶的自評健康狀態",
      x="調查年度",y="平均分數",caption="(1分最低，5分最高)")+mytheme->graph2$Shealthp
ggplotly(
...
eco_satis %>%
  ...
  geom_point(size=3,alpha=0.8)+
    ...
    labs(title="主樣本的自評經濟滿意度",
      x="調查年度",y="平均分數",caption="(1分最低，4分最高)")+mytheme->graph2$eco_satis
ggplotly(
...
work_satis %>%
  ...
  geom_point(size=3,alpha=0.8)+
    ...
    labs(title="主樣本的自評工作滿意度",
      x="調查年度",y="平均分數",caption="(1分最低，4分最高)")+mytheme->graph2$work_satis
ggplotly(
...
family_satis %>%
  ...
  geom_point(size=3,alpha=0.8)+
    ...
    labs(title="主樣本的自評家庭滿意度",
      x="調查年度",y="平均分數",caption="(1分最低，4分最高)")+mytheme->graph2$family_satis
ggplotly(
...
marry_satis %>%
  ...
  geom_point(size=3,alpha=0.8)+
    ...
    labs(title="主樣本的自評婚姻(同居)滿意度",
      x="調查年度",y="平均分數",caption="(1分最低，4分最高)")+mytheme->graph2$marry_satis
ggplotly(
...
save(
  ...
  family_satis,marry_satis,scale,mytheme,
  file="psfddata2.Rda")
