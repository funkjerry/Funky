...
annotate("text",x=0.5,y=5.45,size=5,label="N",fontface="bold")+labs(title="主樣本的生活快樂感和生活過得好不好",x="主樣本出生年度(每十年一單位)",y="平均分數",caption = "(1分最低，7分最高)")->graph$happylife10
###happy life n
data3 %>%
  filter(category == "H") %>%
...
data6 %>%
  ...
  labs(
    title="主樣本和其伴侶的自評健康分數",x="主樣本出生年度(每十年一單位)",y="平均分數",caption = "(2.5 ~ 4.5區間，1分最低，5分最高)")+
